...
public class StardewGuideTool {
    ...
    @AiTool(
            name = "stardew_guide",
            description = "查询星露谷物语攻略知识库。用户问夏天能钓什么鱼、某个收集包/重混随机收集包需要什么、"
                    ...
                    + "博物馆捐赠、全 42 古物/文物、具体古物怎么获得/哪里刷、全 53 矿物、具体矿物怎么获得/开哪个晶球、晶球、万象晶球、古物宝藏、缺失藏品怎么补、"
                    ...
                    + "火山锻造台、武器宝石锻造、工具附魔、武器附魔、银河之魂/无限武器、戒指合成、"
                    + "精通系统/精通点/精通先选哪个、铱金镰刀/高级铱金鱼竿/挑战鱼饵/宝藏图腾/铁砧/迷你锻造台、"
                    + "小饰品/饰品怎么获得、铁砧重铸、仙女盒/青蛙蛋/寒冰法杖/魔法箭筒/鹦鹉蛋/蜥怪的爪子/魔法发胶、"
