...
- 本地数据加载日志规模符合预期：fish=74、bundles=37、crops=30、buildings=18、tools=6、machines=17、shops=9、villagers=34、resources=35、cookingRecipes=19、guides=33。
...
- 金额、材料、地点、耗时、顺序限制清楚。
- `金钱` 不误判为金级工具。
- 机器和资源交叉问题应按动词判断，例如“树脂怎么获得”优先资源，“小桶怎么做”优先机器。
...
- AI 空返回或异常时有本地检索回退。
- 居民、工具、资源、收集包、鱼类五类高频问题至少各有一条人工验收通过。
