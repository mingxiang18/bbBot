...
- 机器/加工/制作设备：39 个，覆盖小桶、罐头瓶、蛋黄酱机、奶酪压制机、织布机、产油机、蜂房、熔炉、木炭窑、回收机、种子生产器、宝石复制机、避雷针，以及 1.6 的鱼熏机、脱水机、诱饵制造机、蘑菇木桩；新增洒水器、炸弹、楼梯、箱子、标牌、稻草人、太阳能板、重型熔炉、史莱姆设备、骨头磨坊、晶球破开器、料斗、农场电脑等常问制作设备
...
- 机器/加工/制作设备已扩到 39 个核心条目，但重型树液采集器、虫饵盒、豪华虫饵盒、木材削片机、蟹笼、肥料、图腾、戒指、后期精通设备和全制作清单还未完整结构化。
...
1. 数据覆盖：
   ...
   - 全建筑、房屋升级、动物、机器；首批核心农场建筑、房屋升级和 39 个核心机器/制作设备已结构化，后续补方尖塔/黄金钟/社区升级/特殊建筑和全部机器设备
