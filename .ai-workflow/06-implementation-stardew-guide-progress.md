...
- 资源获取已扩到 62 项，新增一批博物馆、古物、矿物、晶球和稀有物品；但全 42 件古物、全 53 件矿物、全怪物掉落、全姜岛/火山材料、全鱼塘产物和特殊货币还未完整结构化。
...
1. 数据覆盖：
   ...
   - 矿井、骷髅洞穴、火山、怪物掉落、博物馆、烹饪、制作；首批 62 个高频资源获取条目已结构化，后续继续补全 42 件古物、53 件矿物和怪物掉落表
2. 测试覆盖：
