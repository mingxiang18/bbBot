...
- 商店/商人：15 个常用条目，覆盖皮埃尔、铁匠、罗宾、玛妮、威利、科罗布斯、旅行货车、沙漠商人、书商、冒险家公会、矮人商店、绿洲、姜岛商人、齐先生核桃房、星之果实餐吧，以及背包、干草、铱制洒水器、楼梯、鱼竿/鱼饵、技能书、武器、炸弹、杨桃种子、姜岛树苗、齐钻商品、咖啡/料理配方等常问商品/兑换
...
- 商店已优先覆盖 15 个常用购买/兑换入口；赌场、火山矮人、冰淇淋摊、节日商店、沙漠节特殊库存、全量旅行货车随机池等后续继续补齐。
