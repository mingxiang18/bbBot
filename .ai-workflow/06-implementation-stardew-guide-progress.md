...
- 资源获取已扩到 161 项，新增一批博物馆、全 42 件古物、全 53 件矿物、晶球、稀有物品、动物产品、果树水果和首批高频怪物掉落；怪物掉落表已单独拆成 `monsterDrops=58` 结构化类目；但全姜岛/火山材料、全鱼塘产物和特殊货币还未完整结构化。
...
1. 数据覆盖：
   ...
   - 矿井、骷髅洞穴、火山、怪物掉落、博物馆、烹饪、制作；首批 161 个资源获取条目已结构化，已补煤炭、太阳精华、虚空精华、蝙蝠翅膀、史莱姆泥、虫肉、骨头碎片等高频怪物掉落，并已补全 53 件矿物、42 件古物和 58 个怪物掉落表条目，后续继续补姜岛/火山材料、全鱼塘产物和特殊货币
2. 测试覆盖：
